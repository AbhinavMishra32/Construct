...
| 1 | Shared schemas & canonical sample project | Implemented | Shared schemas, blueprint validation script, real workflow runtime sample project, and Jest tests are in place. Full test execution is blocked until dependencies can be installed. |
...
- Define shared schemas for blueprints, steps, task results, learner state, and snapshots.
- Add the canonical sample workflow runtime with Jest test coverage.
- Add sample blueprint metadata and validation tooling.
