...
- Phase 4 Monaco editor integration, blueprint file tree, and anchor navigation.
- A stored implementation ledger at `docs/implementation-ledger.md`.

## Workspace

- `app`: Electron main, preload, and React renderer.
- `runner`: local runner service, workspace file manager, snapshot service, task test runner, and blueprint API surface.
